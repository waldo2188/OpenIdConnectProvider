...
namespace Waldo\OpenIdConnect\ProviderBundle\Composer;
 ...
 * ScriptHandler
 *
 * @package    WaldoopenIdConnectProviderBundle
 * @subpackage Composer
...
class ScriptHandler
{
    ...
    public static function install(CommandEvent $event)
    {
        ...
        static::executeCommand($event, $consolePath, 'waldo:oicp:install', $options['process-timeout']);
    }
