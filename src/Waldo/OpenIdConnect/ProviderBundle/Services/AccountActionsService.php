...
use Waldo\OpenIdConnect\ProviderBundle\Services\Mailing\MailingService;
...
class AccountActionsService
{
    ...
    {
        /* @var $account Account */
        $account = $this->em->getRepository("WaldoOpenIdConnectProviderBundle:Account")
    ...
    public function isValidLostPasswordToken($token)
    {
        ...
        $accountAction = $this->em->getRepository("WaldoOpenIdConnectProviderBundle:AccountAction")
