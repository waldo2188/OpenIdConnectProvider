...
class LdapConnection implements LdapConnectionInterface
{
    ...
    /**
     * @return true
     * @throws \Waldo\OpenIdConnect\LdapProviderBundle\Exceptions\ConnectionException | Connection error
     */
     ...
     *
     * @throws \Waldo\OpenIdConnect\LdapProviderBundle\Exception\ConnectionException
     */
